...
var supportedModems = []SupportedModem{
	...
	{"1bc7", "1230", "Telit", "LE910Cx RMNET + Audio", "if04" },
	{"1bc7", "1231", "Telit", "LE910Cx RNDIS + Audio", "if05" },
	{"1bc7", "1250", "Telit", "LE910Cx RMNET + GNSS", "if04" },
	{"1bc7", "1251", "Telit", "LE910Cx RNDIS + 4 Serial", "if05" },
	{"1bc7", "1252", "Telit", "LE910Cx MBIM + 4 Serial", "if05" },
	{"1bc7", "1253", "Telit", "LE910Cx ECM + 4 Serial", "if05" },
	{"1bc7", "1254", "Telit", "LE910Cx Dual Modem", "if00" },
	{"1bc7", "1255", "Telit", "LE910Cx GNSS + Dual Modem", "if02" },
	{"1bc7", "1260", "Telit", "LE910Cx RMNET Default", "if04" },
	{"1bc7", "1261", "Telit", "LE910Cx RMNET Alt Layout", "if04" },
	{"1bc7", "1262", "Telit", "LE910Cx Multi-Serial + AUX", "if05" },
	// Telit ThreadX variants
	...
	{"1bc7", "1038", "Telit", "LE910Cx ThreadX Dual Modem + RMNET", "if02" },
	{"1bc7", "103b", "Telit", "LE910Cx ThreadX DIAG + Dual Modem", "if02" },
	{"1bc7", "103c", "Telit", "LE910Cx ThreadX Dual Modem Only", "if02" },
	// Telit ME910C1
